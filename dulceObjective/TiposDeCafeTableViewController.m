...
@property (strong, nonatomic) TiposDeCafePresenter *tiposDeCafePresenter;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
	if ([segue.identifier isEqualToString:@"showTipoDetalhe"]) {
		...
		CafeSelecionadoViewController *destViewController = segue.destinationViewController;
